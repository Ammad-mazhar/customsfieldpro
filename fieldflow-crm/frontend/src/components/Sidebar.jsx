...
import { clearAllData, getLowStockCount } from '../data/store'
    ...
    <>
      ...
      <aside className={`sidebar-mobile${isOpen ? ' open' : ''}`} style={styles.sidebar}>
        ...
        <button onClick={() => window.dispatchEvent(new CustomEvent('fieldflow:search'))}
          style={{ margin: '6px 12px 2px', display: 'flex', alignItems: 'center', gap: 8, padding: '8px 11px', background: '#f3f4f6', border: '1px solid #e8e9ec', borderRadius: 8, cursor: 'pointer', width: 'calc(100% - 24px)', color: '#9ca3af', fontSize: 12.5 }}>
...
const styles = {
  sidebar:    { width: 228, minWidth: 228, background: '#ffffff', borderRight: '1px solid #e8e9ec', display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' },
  brand:      { display: 'flex', alignItems: 'center', gap: 10, padding: '20px 20px 16px', borderBottom: '1px solid #f0f1f3' },
  ...
  brandName:  { fontSize: 17, fontWeight: 700, color: '#1a1d23', letterSpacing: '-0.3px' },
  nav:        { flex: 1, padding: '12px 10px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 2 },
  navLabel:   { fontSize: 10, fontWeight: 600, color: '#9ca3af', letterSpacing: '0.8px', padding: '8px 10px 6px', margin: 0 },
  link:       { display: 'flex', alignItems: 'center', gap: 10, padding: '10px 10px', minHeight: 48, borderRadius: 7, fontSize: 14, fontWeight: 500, color: '#4b5563', textDecoration: 'none', transition: 'background 0.12s, color 0.12s' },
  linkActive: { background: '#eff6ff', color: '#2563eb' },
  icon:       { display: 'flex', alignItems: 'center', flexShrink: 0, opacity: 0.9 },
  footer:     { padding: '14px 16px', borderTop: '1px solid #f0f1f3', display: 'flex', flexDirection: 'column', gap: 10 },
  ...
  avatarName: { fontSize: 13, fontWeight: 600, color: '#1a1d23', margin: 0 },
  avatarRole: { fontSize: 12, color: '#9ca3af', margin: 0 },
  resetBtn:   { width: '100%', padding: '7px 0', background: 'none', border: '1px solid #e8e9ec', borderRadius: 7, fontSize: 12, color: '#9ca3af', cursor: 'pointer', fontWeight: 500, letterSpacing: '0.1px' },
}
