...
export default function Clients() {
  ...
  function update(newArr) { setClients(newArr); saveClients(newArr) }
  ...
  function submit(andCreateAnother = false) {
    const e = validate()
          ...
          {tab==='detail'&&sel&&(
            <div style={{display:'flex',flexDirection:'column',gap:20}}>
              ...
              {(() => {
                ...
                const googleUrl = getSettings().reviews?.googleReviewUrl
                return (
                  <div style={C}>
                    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12}}>
                ...
                <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.45)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:2000}}>
                  <div style={{background:'#fff',borderRadius:14,padding:'28px 28px 24px',width:420,maxWidth:'92vw',boxShadow:'0 8px 32px rgba(0,0,0,0.18)'}}>
                    ...
                    <p style={{fontSize:13,color:'#9ca3af',margin:'0 0 18px'}}>
                      A review request will be sent to {sel.firstName || sel.name} via SMS{sel.email?' and Email':''}.
                    </p>
                    {reviewSent ? (
            ...
            <div style={{maxWidth:800,margin:'0 auto',background:'#fff'}}>
              ...
              <div style={{display:'flex',gap:40}}>
                ...
                <div style={{flex:1,display:'flex',flexDirection:'column',gap:12}}>
                  ...
                  <a href="#" onClick={e=>e.preventDefault()} style={{color:'#16a34a',fontSize:13,textDecoration:'none',fontWeight:500}}>Communication settings</a>
